...
### 2. implement the different actions in Script:main() directly or with helper functions do_list
### 3. implement helper functions you defined in previous step
### ==============================================================================

### Created by Peter Forret ( pforret ) on 2024-10-04
...
readonly script_created="2024-10-04"
readonly run_as_root=-1 # run_as_root: 0 = don't check anything / 1 = script MUST run as root / -1 = script MAY NOT run as root
readonly script_description="list and manage wsl volumes"
